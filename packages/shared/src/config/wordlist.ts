...
export const DEFAULT_WORDLIST: WordEntry[] = [
  ...
  /* ── TERZA ONDATA: AGGRESSIVITÀ E ODIO ────────────────────────────────
     Le due ondate precedenti coprivano le parole. Questa copre i *modi*: il
     disprezzo rivolto a una persona, l'incitamento contro un gruppo, le
     molestie insistite. Sono espressioni che raramente contengono una
     parolaccia e che fanno più danno di quante ne contengano.

     Il criterio resta lo stesso, e qui pesa di più: ogni voce deve essere
     offensiva anche senza contesto. «Non ti sopporto» non entra — è una cosa
     che si dice fra amici; «nessuno ti sopporta» sì, perché parla a nome di
     tutti contro uno. */

  /* Disprezzo rivolto alla persona: la forma tipica del flame. */
  ...v(
    'INSULTO',
    'MEDIA',
    'sei una merda umana',
    ...
    'levati di mezzo',
    'sparisci da qui',
    'vattene da questo server',
    'non tornare mai piu',
    'fai schifo come persona',
    'sei disgustoso',
    'sei disgustosa',
    'sei patetico forte',
    'ma vaffanculo va',
    ...
    'sei bugiardo di merda',
    'sei falso di merda',
    'sei un pagliaccio triste',
  ),

  /* Molestie: insistenza, scherno ripetuto, esposizione. */
  ...v(
    'INSULTO',
    'GRAVE',
    ...
    'faccio girare le tue foto',
    'mando tutto ai tuoi',
    'lo dico a tutti quanto fai schifo',
    'ti faccio bannare da ovunque',
    'ti rovino la reputazione',
    'ti sputtano ovunque',
    'so tutto di te e lo dico',
    'ti espongo',
    'ti faccio smerdare',
  ),

  /* Odio contro gruppi: incitamento e disumanizzazione. */
  ...v(
    'DISCRIMINAZIONE',
    'GRAVE',
    'meritano di sparire',
    ...
    'fuori dalle palle stranieri',
    'prima gli italiani sempre e comunque',
    'kill all',
    'gas them',
  ...
  /* Sessismo e molestie sessuali: il caso più frequente e il meno elencato. */
  ...v(
    'DISCRIMINAZIONE',
    'GRAVE',
    'le donne non capiscono niente',
    'le donne servono solo a',
    'sei solo una donna',
    'stai zitta che sei una donna',
    'torna ai fornelli',
    'donne al loro posto',
    'te la sei cercata',
    'sei vestita come una',
    'quanto costi',
    'fammi vedere le tette',
    'fammi vedere il culo',
    'ti verrei addosso',
    'ti prenderei con la forza',
    'te lo meriti uno stupro',
    'lo stupro non esiste',
    'sei un pezzo di carne',
    'vali solo per il corpo',
  ),

  /* Aggressività esplicita che non arriva alla minaccia diretta ma la sfiora. */
  ...v(
    'MINACCIA',
    'MEDIA',
    ...
    'non farti trovare',
    'vediamo se hai il coraggio dal vivo',
    'ripetimelo in faccia',
    'diccelo in faccia allora',
    'ci vediamo fuori',
    'ci vediamo dal vivo',
    'so come trovarti',
    'ho i tuoi dati',
    ...
    'ti droppo l ip',
    'ti faccio ddos',
    'ti buttiamo giu il server',
  ),

  /* Istigazione mascherata da consiglio: la forma più insidiosa. */
  ...v(
    'AUTOLESIONISMO',
    'GRAVE',
    ...
    'levati dal mondo',
    'toglietevi dal mondo',
    'nessuno sentirebbe la tua mancanza',
    'la tua famiglia starebbe meglio senza di te',
    'perche sei ancora vivo',
    'perche non sparisci per sempre',
    'do everyone a favor',
    'nobody would miss you',
  ),

  /* Volgarità aggiuntive di uso corrente. */
  ...v(
    'VOLGARITA',
    'LIEVE',
    'che cazzo vuoi',
...
export const DEFAULT_ALLOWLIST: string[] = [
  // introdotte con la terza ondata: aggressività e odio
  'gallina',
  'galline',
  'balcone',
  'venerdi',
