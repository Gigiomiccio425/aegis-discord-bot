...
| `/lockdown attiva\|revoca\|stato` | Gestisci server | Canali in sola lettura — chat delle vocali comprese, parlare resta possibile — e inviti in pausa. Dice quali canali non ha chiuso, e perché |
...
| `/copia-leggera adesso\|rimetti` | Amministratore | Pubblica subito la copia leggera nel suo canale, o rimette la configurazione dall'ultima pubblicata — vedi [Backup](backup-e-trasloco.md#5-la-copia-leggera--su-discord) |
