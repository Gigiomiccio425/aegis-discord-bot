...
Succede a chi viene da una versione senza il file dei segreti: la 1.27.x o precedenti. Travasali
**prima** di aggiornare, finché sono
...
che la cartella dei segreti non è scrivibile da ANGEL. Dalla 1.31.0 un container la sistema da
